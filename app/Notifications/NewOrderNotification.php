...
class NewOrderNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('Une nouvelle commande a été passée sur la boutique.')
            ->line('Numéro de commande : ' . $this->order->order_number)
            ->line('Montant total : ' . $this->order->total_amount . ' DH')
            ->action('Voir la commande', 'https://oureliabeauty.com/admin/login')
